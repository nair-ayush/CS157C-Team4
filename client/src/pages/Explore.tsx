...
export default function Explore() {
  ...
  const emptyrestRows =
    page > 0 ? Math.max(0, (1 + page) * rowsPerPage - restaurantsData.length) : 0;
  ...
  return (
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
        <TableBody>
          {(rowsPerPage > 0
            ? restaurantsData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            : restaurantsData
          ).map((restaurantsData) => (
    ...
    <TableContainer component={Paper}>
      <Table sx={{ minWidth: 500 }} aria-label="custom pagination table">
        <TableBody>
          {(rowsPerPage > 0
            ? listingsData.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
            : listingsData
          ).map((listingsData) => (
